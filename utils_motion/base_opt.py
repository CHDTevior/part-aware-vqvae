...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--name', type=str, default="t2m_nlayer8_nhead6_ld384_ff1024_cdp0.1_rvq6ns_0530", help='Name of this trial')

        self.parser.add_argument('--vq_name', type=str, default="my_rvq", help='Name of the rvq model.')
        ...
        self.parser.add_argument("--data_root", type=str, default='/mnt/afs/datasets/HumanML3D_raw', help='data root')
