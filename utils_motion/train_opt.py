...
from utils_motion.base_opt import BaseOptions
...
class TrainT2MOptions(BaseOptions):
    def initialize(self):
        ...
        # self.parser.add_argument("--data_root", type=str, default='/mnt/afs/datasets/HumanML3D_MixCMP_MoxtionX', help='data root')
        # self.parser.add_argument("--dataset_opt_path", type=str, default='./checkpoints/t2m/Comp_v6_KLD005/opt.txt', help='dataset opt path')
        ...
        self.parser.add_argument('--eval_every_e', type=int, default=30, help='Frequency of animating eval results, (epoch)')
...
# python trainers/train_transformotion.py --dataset_name t2m --name trm_xl_b38_d1024_20250108 --vq_name rvq_n8192_d128 --gpu_id 0 --is_continue