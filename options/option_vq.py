...
def get_args_parser():
    ...
    parser.add_argument('--batch-size', default=256, type=int, help='batch size') #256
    ...
    ## vqvae arch
    parser.add_argument("--code-dim", type=int, default=128, help="embedding dimension") #512
    parser.add_argument("--nb-code", type=int, default=128, help="nb of embedding")
    parser.add_argument("--mu", type=float, default=0.99, help="exponential moving average to update the codebook")
    parser.add_argument("--down-t", type=int, default=2, help="downsampling rate") #2
    parser.add_argument("--stride-t", type=int, default=2, help="stride size")
    parser.add_argument("--width", type=int, default=512, help="width of the network")
    parser.add_argument("--depth", type=int, default=3, help="depth of the network")
    parser.add_argument("--dilation-growth-rate", type=int, default=3, help="dilation growth rate")
    parser.add_argument("--output-emb-width", type=int, default=128, help="output embedding width") # 512
    ...
    ## partition (data-driven skeleton segmentation)
    parser.add_argument("--partition-file", type=str, default=None,
                        help="Path to skeleton_partition.json for data-driven part segmentation")
